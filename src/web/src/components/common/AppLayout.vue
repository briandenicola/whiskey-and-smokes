...
const navItems = [
  ...
  { name: 'Recommend', path: '/recommendations' },
      ...
      <div class="flex justify-around items-end pt-1 pb-2">
        <template v-for="item in navItems" :key="item.path">
          ...
          >
            ...
            <!-- Search -->
            <svg v-else-if="item.path === '/search'" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mb-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <!-- Recommendations -->
            <svg v-else-if="item.path === '/recommendations'" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mb-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
